  ...
  return (
    <div className="container flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] py-12 text-center">
      <div className="flex flex-col items-center max-w-md space-y-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Halaman Dalam Pengembangan</h1>

        <p className="text-muted-foreground text-lg">
          Mohon maaf, halaman yang Anda cari sedang dalam proses pengembangan dan belum tersedia saat ini.
        </p>

        <div className="flex items-center justify-center p-4 rounded-lg bg-muted/50 w-full">
          <Clock className="w-5 h-5 mr-2 text-muted-foreground" />
          <p className="text-sm text-muted-foreground">
            Tim kami sedang bekerja keras untuk menyelesaikan fitur ini secepatnya.
          </p>
        </div>
